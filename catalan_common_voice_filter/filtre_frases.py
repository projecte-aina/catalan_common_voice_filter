...
def check_if_line_is_a_name(
    ...
    if exclude_proper_nouns and is_name(line, surnames):
        exclude_phrase = True
        excluded_names.append(original_phrase)

    return excluded_names, exclude_phrase
...
def main():
    ...
    for line in sentences:
        ...
        if is_line_length_correct(line):
            ...
            if are_excluded_characters_in_line:
                exclude_phrase = True
            ...
            if (
                ...
                if args.numbers == True and any(element in line for element in NUMBERS):
